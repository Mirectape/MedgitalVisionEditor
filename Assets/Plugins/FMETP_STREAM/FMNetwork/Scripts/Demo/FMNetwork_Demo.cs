...
namespace FMSolution.FMNetwork
{
    public class FMNetwork_Demo : MonoBehaviour
    {
        ...
        private Queue<string> serverTextQueue = new Queue<string>();
        private Queue<string> clientTextQueue = new Queue<string>();
        ...
        public FMNetworkTransformView Box1;
        public FMNetworkTransformView Box2;
        ...
        private void Update()
        {
            if (fmnetwork.NetworkType == FMNetworkType.Server && fmnetwork.Initialised)
            {
                ...
                bool _toggleOn = toggle.isOn;
                if (Box1 != null)
                {
                    Box1.enabled = _toggleOn;
                    if (_toggleOn)
                    {
