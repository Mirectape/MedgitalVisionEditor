...
namespace Crosstales.Common.Util
{
   ...
   public abstract class BaseConstants
   {
      ...
      public const string COMMON_VERSION = "2024.1.0";

      /// <summary>Build number of the Common.</summary>
      public const int COMMON_BUILD = 20240127;

      /// <summary>Change date of the Common (YYYY, MM, DD).</summary>
      public static readonly DateTime COMMON_CHANGED = new DateTime(2024, 1, 27);
